//
//  CD_TVC_inside_a_standard_VC.h
//  CelebrityBeerAndWings
//
//  Created by Andrew (Laptop) on 3/27/13.
//  Copyright (c) 2013 Andrew (Laptop). All rights reserved.
//

// NOTE THE MODIFICATIONS TO MAKE THE TVC WORK WITHIN A VIEW THAT CONTAINS MORE THAN JUST THE TVC
...
// NOTE NOTE NOTE: 3/21/13 HAD TO MAKE THIS A UIVIEWCONTROLLER that serves as UITableViewDataSource and UITableViewDelegate and has a UITableView property
@interface CD_TVC_inside_a_standard_VC : UIViewController <NSFetchedResultsControllerDelegate, UITableViewDataSource, UITableViewDelegate>
